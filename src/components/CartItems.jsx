...
//                               <tb><div className="bold-22 relative left-1/2"><TbTrash onClick={()=>{
//                                 removeFromCart(e.id)
//                               }}/></div></tb>
//                             </tr>
//                         }
...
//       if (cartItems[e.id] > 0) {
//         message += `\nProduct: ${e.name}\nPrice: MRP-/${e.new_price}\nQuantity: ${cartItems[e.id]}\nTotal: MRP-/${e.new_price * cartItems[e.id]}\n`;
//       }
//     });
//     message += `\nTotal Amount: MRP-/${getTotalCartAmount()}\nThank you for your order!`;

//     const whatsappUrl = `https://api.whatsapp.com/send?phone=919511294735&text=Hello,%20*Oyster ?text=${encodeURIComponent(message)}`;
...
//                     </td>
//                     <td>MRP-/{e.new_price}</td>
//                     <td className="w-16 h-16 bg-white">{cartItems[e.id]}</td>
//                     <td>MRP-/{e.new_price * cartItems[e.id]}</td>
//                     <td>
...
//               <div className="flexBetween py-4">
//                 <h4 className="medium-16">Subtotal:</h4>
//                 <h4 className="text-gray-30 font-semibold">MRP-/{getTotalCartAmount()}</h4>
//               </div>
//               <hr />
//               <div className="flexBetween py-4">
//                 <h4 className="medium-16">Shipping Fee:</h4>
...
//               <div className="flexBetween py-4">
//                 <h4 className="medium-18">Total:</h4>
//                 <h4 className="bold-18">MRP-/{getTotalCartAmount()}</h4>
//               </div>
//             </div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div>
              ...
              <div className="flexBetween py-1">
                {/* <h4 className="medium-16">Shipping Fee: Pune-60  :   Maharashtra-90 </h4> */}
            ...
            <button className="btn-dark w-44 rounded-xl" onClick={handleCheckout}>Checkout</button>
            <h4 className="medium-16">Shipping Fee Charges: Pune-60  :   Maharashtra-90 </h4>
            </div>
          </div>
          <div className="flex flex-col gap-10">
            <h4 className="bold-20 capitalize">Discount:</h4>
            <div className="flexBetween pl-5 h-[3.3rem] bg-white ring-1 ring-slate-900/10 w-full max-w-[366px] rounded-xl">
              {/* <input type="text" placeholder="coupon code" className="bg-transparent border-none outline-none" /> */}
              <button className="btn-dark rounded-lg relative right-[0.33rem">20%</button>
            </div>
          </div>
        </div>
      </div>
